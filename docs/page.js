...
_vue2.default.filter('i18n', _utils.i18n);
_vue2.default.mixin({
  methods: {
    i18n: _utils.i18n
  },
  watch: {
    language: function language() {
      _vue2.default.config.lang = this.language;
      this.$forceUpdate();
    }
  }
});
...
var _dataSource = __webpack_require__(50);
...
exports.default = {
  ...
  computed: {
    tabs: function tabs() {
      if (!Array.isArray(_dataSource2.default)) {
        return [];
      }
      return _dataSource2.default.map(function (category) {
    ...
    selectedCategory: function selectedCategory() {
      ...
      return _dataSource2.default.filter(function (tab) {
